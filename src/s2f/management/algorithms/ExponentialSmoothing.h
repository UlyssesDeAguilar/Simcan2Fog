...
#ifndef MANAGEMENT_ALGORITHMS_EXPONENTIALSMOOTHING_H_
#define MANAGEMENT_ALGORITHMS_EXPONENTIALSMOOTHING_H_
...
#endif /* MANAGEMENT_ALGORITHMS_EXPONENTIALSMOOTHING_H_ */
