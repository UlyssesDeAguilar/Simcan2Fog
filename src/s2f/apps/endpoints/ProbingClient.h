...
#ifndef SIMCAN_EX_PROBINGCLIENT_H__
#define SIMCAN_EX_PROBINGCLIENT_H__
...
class ProbingClient : public AppBase, public AppBase::ICallback
{
protected:
  int sockFd;
  bool started;
...
#endif /* SIMCAN_EX_PROBINGCLIENT_H__ */
