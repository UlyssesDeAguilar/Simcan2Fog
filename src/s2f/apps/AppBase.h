  ...
  public:
    class ICallback
    {
      public:
        ...
        virtual void handleResolutionFinished(const std::set<L3Address> ipResolutions, bool resolved)
        {
            handleResolutionFinished(ipResolutions.size() ? *ipResolutions.begin() : L3Address(), resolved);
        }
