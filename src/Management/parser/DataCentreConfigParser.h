...
#ifndef MANAGEMENT_PARSER_DATACENTRECONFIGPARSER_H_
#define MANAGEMENT_PARSER_DATACENTRECONFIGPARSER_H_

#include "Parser.h"
#include "Management/dataClasses/DataCentre.h"

class DataCentreConfigParser: public Parser<DataCentre> {
public:
    DataCentreConfigParser(const char *s);
    virtual ~DataCentreConfigParser();
