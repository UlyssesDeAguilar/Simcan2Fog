...
#include "DataCenterReservationConfigParser.h"

DataCenterReservationConfigParser::DataCenterReservationConfigParser(const char *s) : DataCenterConfigParser(s) {
    result = SC_OK;
}

DataCenterReservationConfigParser::~DataCenterReservationConfigParser() {
    // TODO Auto-generated destructor stub
}


int DataCenterReservationConfigParser::parse() {
        ...
        if ((tokenizer.hasMoreTokens()) && (result==SC_OK)){
          ...
          EV_ERROR << "Cannot read number of reserved nodes of the Data-Center:" << dataCenterNameStr << endl;
          result = SC_ERROR;
        }
        ...
        if (result==SC_OK){
            ...
            dataCenterObj = new DataCenterReservation (dataCenterNameStr, nReservedNodes);
