...
DataCentreListParser::DataCentreListParser(const char *s) : Parser<DataCentre>(s) {
    result = SC_OK;
    numDataCentres = currentDataCentre = 0;
}

DataCentreListParser::~DataCentreListParser() {
    // TODO Auto-generated destructor stub
}

int DataCentreListParser::parse() {
        ...
        while ((tokenizer.hasMoreTokens()) && (currentDataCentre < numDataCentres) && (result==SC_OK)){
            ...
            if (result==SC_OK){
                ...
                dataCentreObj = new DataCentre (dataCentreNameStr);
