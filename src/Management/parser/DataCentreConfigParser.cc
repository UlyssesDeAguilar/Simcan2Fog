...
DataCentreConfigParser::DataCentreConfigParser(const char *s) : Parser<DataCentre>(s) {
    result = SC_OK;
}

DataCentreConfigParser::~DataCentreConfigParser() {
    // TODO Auto-generated destructor stub
}


int DataCentreConfigParser::parse() {
