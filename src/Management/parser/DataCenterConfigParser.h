...
#ifndef MANAGEMENT_PARSER_DATACENTERCONFIGPARSER_H_
#define MANAGEMENT_PARSER_DATACENTERCONFIGPARSER_H_

#include "Parser.h"
#include "Management/dataClasses/DataCenter.h"

class DataCenterConfigParser: public Parser<DataCenter> {
public:
    DataCenterConfigParser(const char *s);
    virtual ~DataCenterConfigParser();
