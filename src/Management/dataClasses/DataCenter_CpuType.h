#ifndef DATACENTERCPUTYPE_H_
#define DATACENTERCPUTYPE_H_

#include <string.h>
#include <omnetpp.h>
#include "DataCenter.h"
#include "Management/CloudProviders/CloudProviderBase_firstBestFit/NodeResourceInfo.h"
/**
 *
...
class DataCenter_CpuType{
    ...
    public:
        ...
        * Constructor.
        */
        DataCenter_CpuType(std::string name);

       /**
        * Destructor.
        */
        virtual ~DataCenter_CpuType();
        ...
        */
        ...
        /**
         * Get the total number of available cores of the datacenter
         * @return Number of available cores
         */
        int getTotalAvailableCores(){return nTotalAvailableCores;};
        /**
         * Get the total number of total cores of the datacenter
        ...
        /**
         * Provides information about the available resources of the datacenter.
         * @return String with the information of the datacenter
         */
