...
{
private:
    std::string vmInstanceID; // Name that unequivocally identifies this VM instance.
    std::string vmType;       // Type of the VM in the SIMCAN repository.
    ...
    std::string userID;       // User that generated this VM instance.
